...
static inline int i2c_write( unsigned char slave_addr,
					  unsigned char reg_addr,
					  unsigned char length,
					  unsigned char const *data )
{
	return i2cWriteBuffer( slave_addr, reg_addr, length, (uint8_t*)data) == 0;
}

static inline int i2c_read( unsigned char slave_addr,
					 unsigned char reg_addr,
					 unsigned char length,
					 unsigned char *data )
{
	return i2cRead( slave_addr, reg_addr, length, data) == 0;
}
...
#define delay_ms	time_waitMs
static inline int get_ms( unsigned long* cnt )
{
...
extern unsigned int gyro_readBuf( unsigned char slaveAddr, unsigned char reg, unsigned char* buffer, unsigned int length );
extern unsigned int gyro_writeBuf( unsigned char slaveAddr, unsigned char reg, const unsigned char* buffer, unsigned int length );
static int i2c_write( unsigned char slave_addr,
					  unsigned char reg_addr,
					  unsigned char length,
					  unsigned char const *data )
{
	return gyro_writeBuf( slave_addr, reg_addr, data, length );
}
...
static int i2c_read( unsigned char slave_addr,
					 ...
					 unsigned char *data )
{
	return gyro_readBuf( slave_addr, reg_addr, data, length );
}
#endif
